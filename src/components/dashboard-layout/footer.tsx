...
export const RoomFooter = () => (
  <svg className='fixed bottom-0 -z-10 fill-primary/65 dark:fill-primary/10' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path d="M0,128L120,122.7C240,117,480,107,720,106.7C960,107,1200,117,1320,122.7L1440,128L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
)
